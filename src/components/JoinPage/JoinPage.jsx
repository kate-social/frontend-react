  ...
  return <div className={classes.pageWrapper}>
    <div className={classes.wrapper}>
      <form className={classes.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={classes.form__textfield + (errors.repeat_password ? ' ' + classes['form__textfield--error'] : '')}>
          <input
        ...
        <button className={classes.form__submit} type="submit">Join</button>
      </form>
    </div>
  </div>
}